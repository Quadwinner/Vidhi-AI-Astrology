...
Deno.serve(async (req) => {
  ...
  try {
    ...
    systemPrompt += `\n\n# शुरुआत — छोटा परिचय (अत्यंत महत्वपूर्ण):\n` +
      `कॉल शुरू होते ही केवल यही छोटा वाक्य बोलें: "नमस्ते! विधि में आपका स्वागत है। बताइए, मैं आपकी किस विषय में मदद करूँ?" ` +
      `परिचय बहुत छोटा रखें — कुल मिलाकर 5 सेकंड से कम, दो वाक्य से ज़्यादा नहीं। ` +
      `शुरुआत में अपने बारे में, ज्योतिष के बारे में, या कुंडली के बारे में कोई लंबी भूमिका या व्याख्यान बिल्कुल न दें। ` +
      `पहला वाक्य बोलने के तुरंत बाद रुक जाएँ और उपयोगकर्ता के जवाब का इंतज़ार करें। ` +
