-- Migration: Create CleverTap user data aggregation function
-- Created: 2025-12-17
-- Purpose: Aggregate all user data for CleverTap sync
...
BEGIN
  ...
  -- Get chat stats with category breakdown
  SELECT
...
-- Add comment
COMMENT ON FUNCTION public.get_user_clevertap_data(UUID) IS 'Aggregates all user data for CleverTap profile sync including call stats, chat categories, payment info, and usage metrics';
